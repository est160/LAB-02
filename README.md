...
1.	นักศึกษาพบปัญหาในกานคอมไพล์โปรแกรมหรือไม่ ถ้าเจอให้บอกที่ผิดและแนวทางการแก้ไข
   ...
   หลังจากเขียนโปรแกรมและทำการคอมไพล์ปรากฎว่าเกิด error เนื่องจาก บรรทัดที่ 57 แจ้งเตือนเพราะเครื่องหมาย { ในโปรแกรมไม่ครบ แก้ไขโดยใส่เครื่องหมาย }
ลงในบรรทัดล่างสุดของโปรแกรม จะทำให้การคอมไพล์ผ่านได้
